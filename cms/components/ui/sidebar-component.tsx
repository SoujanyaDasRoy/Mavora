    ...
    <div className="relative shrink-0 w-full">
      <div className="flex items-center p-1 w-full">
        ...
        <div className="px-2 py-1">
          <div className="text-[16px] font-semibold text-neutral-50">
            Interfaces
          </div>
        </div>
      </div>
...
function IconNavigation({
  ...
  return (
    <aside className="bg-black flex flex-col gap-2 items-center p-4 w-16 h-full min-h-screen border-r border-neutral-800 rounded-l-2xl">
      {/* Logo */}
    ...
    <div className="w-full overflow-hidden transition-all duration-500" style={{ transitionTimingFunction: softSpringEasing }}>
      <div className="flex items-center justify-between">
        <div className="flex items-center h-10">
          <div className="px-2 py-1">
            <div className="text-[18px] font-semibold text-neutral-50 leading-[27px]">
              {title}
            </div>
          </div>
        </div>
...
function DetailSidebar({ activeSection }: { activeSection: string }) {
  ...
  return (
    <aside
      className={`bg-black flex flex-col gap-4 items-start p-4 rounded-r-2xl transition-all duration-500 h-full min-h-screen overflow-y-auto border-r border-neutral-800 ${
        isCollapsed ? "w-16 min-w-16 !px-0 !py-4 justify-center items-center" : "w-72"
      }`}
      style={{ transitionTimingFunction: softSpringEasing }}
    >
      ...
      {!isCollapsed && (
        <div className="w-full mt-auto pt-2 border-t border-neutral-800">
          <div className="flex items-center gap-2 px-2 py-2">
            <AvatarCircle />
            <div className="text-[14px] text-neutral-50 truncate flex-1">Workspace</div>
            <button
              type="button"
...
/** Full two-level sidebar: icon rail on the left + collapsible detail panel on the right */
